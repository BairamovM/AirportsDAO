...
import com.solvd.javalab.dao.interfaces.IAirportClasses;
...
public class AirportClassesDAO implements IAirportClasses {

    private static final Logger logDAO = Logger.getLogger(AirportClassesDAO.class);
    ...
    @Override
    public AirportClasses getByID(Long id) {

        logDAO.trace("Try to find AirportClasses with id = " + id);

        AirportClasses airportClasses = null;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    if (rSet.next()) {
                        airportClasses = new AirportClasses();
    ...
    @Override
    public List<AirportClasses> getAll() {
        ...
        try {
            ...
            try {
                ...
                try {
                    logDAO.trace("Get ResultSet");
                    rSet = prStatement.executeQuery();
                    List<AirportClasses> airportClass = new ArrayList<>();
                    while (rSet.next()) {
                        airportClasses = new AirportClasses();
                        airportClasses.setId(rSet.getLong("id"));
                        airportClasses.setClassType(rSet.getLong("classType"));
    ...
    @Override
    public void save(AirportClasses airportClasses) {
    ...
    @Override
    public void update(AirportClasses airportClasses) {
