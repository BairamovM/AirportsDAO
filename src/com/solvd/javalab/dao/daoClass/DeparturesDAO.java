...
import com.solvd.javalab.dao.interfaces.IDepartures;
...
public class DeparturesDAO  implements IDepartures {

    private static final Logger logDAO = Logger.getLogger(DeparturesDAO.class);
        ...
        try {
            ...
            try {
                ...
                try {
                    logDAO.trace("Get ResultSet");
                    rSet = prStatement.executeQuery();
                    List<Departures> departure = new ArrayList<>();
                    while (rSet.next()) {
                        departures = new Departures();
                        departures.setId(rSet.getLong("id"));
                        departures.setDepartureDate(rSet.getString("departureDate"));
    ...
    @Override
    public void save(Departures departures) {
    ...
    @Override
    public void update(Departures departures) {
