...
import com.solvd.airport.dao.interfaces.IAirports;
...
public class AirportsDAO implements IAirports {

    private static final Logger logDAO = Logger.getLogger(AirportsDAO.class);
    ...
    @Override
    public Airports getByID(Long id) {
