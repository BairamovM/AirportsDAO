...
import com.solvd.airport.dao.interfaces.IClassSeets;
...
public class ClassSeetsDAO implements IClassSeets {
    ...
    @Override
    public ClassSeets getByID(Long id) {

        logDAO.trace("Try to find ClassSeets with id = " + id);

        ClassSeets classSeets = null;
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    if (rSet.next()) {
                        classSeets = new ClassSeets();
                        classSeets.setId(rSet.getLong("id"));
                        classSeets.setClassseets(rSet.getString("classseets"));
                        return classSeets;
                    }
                } finally {
                    try {
            ...
            logDAO.trace("Can't find classSeets");
        } finally {
            try {
                connection.close();
        ...
        if (null == classSeets) {
            logDAO.debug("classSeets not found");
        } else {
            logDAO.trace("Find classSeets");
        }

        logDAO.trace("Return classSeets");
        return classSeets;
    }

    @Override
    public List<ClassSeets> getAll() {
        ...
        try {
            ...
            try {
                ...
                try {
                    logDAO.trace("Get ResultSet");
                    rSet = prStatement.executeQuery();
                    List<ClassSeets> classSeet = new ArrayList<>();
                    while (rSet.next()) {
                        classSeets = new ClassSeets();
                        classSeets.setId(rSet.getLong("id"));
                        classSeets.setClassseets(rSet.getString("classseets"));
            ...
            logDAO.trace("Can't find any classSeets", e);
        } finally {
            try {
                connection.close();
                logDAO.trace("Connection closed");
    ...
    @Override
    public void save(ClassSeets classSeets) {
        ...
        try {
            ...
            logDAO.trace("Can't Updata Data in classSeets", e);
        } finally {
            try {
                connection.close();
                logDAO.trace("Connection closed");
    ...
    public void delete(Long id) {
        ...
        logDAO.trace("Delete Data from classSeets");
        Connection connection = null;
        PreparedStatement prStatement = null;
        ...
        try {
            ...
            logDAO.trace("Can't Delete Data in classSeets");
        } finally {
            try {
                connection.close();
                logDAO.trace("Connection closed");
    ...
    @Override
    public void update(ClassSeets classSeets) {
        ...
        try {
            ...
            logDAO.trace("Can't Update Data in classSeets", e);
        } finally {
            try {
                connection.close();
                logDAO.trace("Connection closed");
