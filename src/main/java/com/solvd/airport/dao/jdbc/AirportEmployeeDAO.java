            ...
            try {
                ...
                try {
                    ...
                    if (rSet.next()) {
                        ...
                        airportEmployees.setId(rSet.getLong("EmployeeSalaries_id"));
                        airportEmployees.setId(rSet.getLong("EmployeePositions_id"));
                        airportEmployees.setId(rSet.getLong("AirportDepartments_id"));
                        airportEmployees.setId(rSet.getLong("Nationalities_id"));
    ...
    public AirportEmployee save(AirportEmployee airportEmployees) {
        ...
        try {
            ...
            try {
                ...
                prStatement.setLong(6, airportEmployees.getId());
                prStatement.setLong(7, airportEmployees.getId());
                prStatement.setLong(8, airportEmployees.getId());
                prStatement.setLong(9, airportEmployees.getId());
